...
* [ ] Optional *periodic IRQ* support for tickless kernels.
* [ ] Publish a `time`‑crate adapter so it can feed `time::UtcOffset` and `OffsetDateTime`.
* [ ] Integration examples for **ArceOS** / **Starry‑Next**.
